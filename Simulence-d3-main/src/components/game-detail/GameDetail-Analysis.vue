  ...
  <div class="game-detail-analysis">
    ...
    <template v-if="resultVisible">
      ...
      <div class="game-detail-description">
        ...
        <div class="gamedetail-title white-text" id="surveytitle">
          QUESTION 3: Did you come across any major game-breaking bugs? If so, please describe them.
        </div>
...
<!--        <div class="gamedetail-title white-text" id="surveytitle">
    ...
    <template v-if="mainVisible">
      ...
      <div class="gda-survey-box">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-clipboard-data gda-icon" viewBox="0 0 16 16">
          <path d="M4 11a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0v-1zm6-4a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0V7zM7 9a1 1 0 0 1 2 0v3a1 1 0 1 1-2 0V9z"/>
          <path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z"/>
          <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
        </svg>
        <h3 class="gda-text">Surveys</h3>
        <button class="survey-btn-add" v-on:click="newSurvey()">Add New Survey</button>
        <div class="gda-survey-list">
          <div v-for="item in surveyObj" class="gda-survey">
            ...
            <button class="survey-btn" v-if="item.status != 0" v-on:click="viewResults(item)">Results</button>
            <button class="survey-btn" v-if="item.status == 0" v-on:click="publishSurvey(item)">Publish</button>
          </div>
        </div>
      </div>
      <div class="gda-interviews-box">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-pencil-square gda-icon" viewBox="0 0 16 16">
      ...
      <div class="gda-in-game-box">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-display gda-icon" viewBox="0 0 16 16">
...
.gda-survey-box, .gda-interviews-box, .gda-in-game-box {
...
.survey-btn:hover, .survey-btn-add:hover {
